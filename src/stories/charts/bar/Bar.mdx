...
<Subtitle>在需要对比不同维度时，条形图对名称的展示更加友好。</Subtitle>
...
- [基础条形图](/story/charts-条形图-bar-chart--bar-default-example)
- [分组条形图](/story/charts-条形图-bar-chart--bar-with-group-example)
- [堆积条形图](/story/charts-条形图-bar-chart--stacking-diagram-bar-example)
- [百分比堆积条形图](/story/charts-条形图-bar-chart--percent-bar-example)
