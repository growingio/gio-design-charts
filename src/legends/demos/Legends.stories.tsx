...
lineLegends.args = {
  legends: getLegends(ChartType.LINE, shortlegendList)[0],
};
...
lineContrastLegends.args = {
  legends: getLegends(ChartType.LINE, contrastLegends)[0],
  offsetWidth: 1000,
};
...
lineLongLegends.args = {
  legends: getLegends(ChartType.LINE, longLegendLast)[0],
};
lineLongLegends.storyName = '线图图例（其他）';

export const barLegends = Template.bind({});
barLegends.args = {
  legends: getLegends(ChartType.BAR, shortlegendList)[0],
};
barLegends.storyName = '方块图例';

export const barLongLegends = Template.bind({});
barLongLegends.args = {
  legends: getLegends(ChartType.BAR, longLegendLast)[0],
};
