...
const BarDefaultArgs = {
  legends: [
    ...
    { name: '目标群组TGI', alias: '目标群组TGI', controlKey: '目标群组', color: '#1248E9', shapeType: 'circle' },
    { name: '对照组', color: '#FFDD63', pointColor: '#FAA937' },
    { name: '对照组TGI', alias: '对照组TGI', color: '#FAA937', controlKey: '对照组', shapeType: 'circle' },
  ],
  data: [
    {
      dimensionValue: '崔宜',
  ...
  config: {
    ...
    point: {
      ...
      shape: 'circle',
      size: 8,
      adjust: [{ type: 'dodge', dodgePadding: 16 }],
    },
    annotation: {
      line: {
        start: ['start', 110],
