...
export const dataWithMulti = [
  { name: '页面浏览的总数量', value: 120124,tgi:150 },
  { name: '访问推出的总数量', value: 241234,tgi:100 },
  { name: '步步盈增的用户量', value: 343455 ,tgi:50},
  { name: '步步盈增的用户量2', value: 343455 ,tgi:5000},
  { name: '步步盈增的用3户量', value: 343455 ,tgi:50},
];
